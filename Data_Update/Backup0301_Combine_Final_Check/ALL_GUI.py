...
theNote_details1=Label(frame2,text='1.The "empty resource rows" or "empty replicas". It may be incorrect because of different data level in YAML file.',font=('Arial',10)).grid(sticky=W,row=3,column=0)
...
theButton1 = Button(frame2, text='RUN', command=run_all_together,justify=RIGHT,default='active',font=('Arial', '10','bold')).grid(sticky=W, row=10,column=50)
